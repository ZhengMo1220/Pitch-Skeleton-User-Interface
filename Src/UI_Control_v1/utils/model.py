...
class Model(object):
    ...
    def setDetectParser(self) -> ArgumentParser:
        ...
        parser.add_argument('--det-config', default=r'..\mmyolo_main\configs\yolov8\yolov8_s_syncbn_fast_8xb16-500e_coco.py', help='Config file for detection')
        parser.add_argument('--det-checkpoint', default=r'..\..\Db\pretrain\yolov8_s_syncbn_fast_8xb16-500e_coco_20230117_180101-5aa5f0f1.pth', help='Checkpoint file for detection')
        parser.add_argument(
    ...
    def setPoseParser(self) -> ArgumentParser:
        parser = ArgumentParser()
        parser.add_argument('--pose-config', default=r'..\mmpose_main\configs\body_2d_keypoint\topdown_heatmap\haple\ViTPose_base_simple_halpe_256x192.py', help='Config file for pose')
