...
# Loaded once on first call, reused for the entire process lifetime.
...
class BaseOCRReader:
    ...
    #
    # Default: empty (no padding). Pitching overrides this per-field
    # because adding padding to total_spin_rpm hurts that field (see
    # Fix 10 measure notes in pitching.py).
    ...
    def _read_field_full(
        ...
        # totals. Pitching uses frac70_min4 thresholds to counter
        # italic-digit leading-eats.
        if votes:
